...
import java.awt.*;
/**
 * This is my class PlayField here.
 * 
...
public class PlayField extends World
{
    ...
    public void reset()
    {
        theBall.setLocation( 400, 300 );
        theBall.setVelocity(0);
        theBall.setRotation(Greenfoot.getRandomNumber (360) - 0) ;
        showText( "press the spacebar to play", 200, 550 );
        startGame = false;
    }
